                        ...
                        >
                            <Link to="/signup">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="px-10 py-5 bg-emerald-500 text-white rounded-2xl font-bold text-lg shadow-2xl shadow-emerald-500/20 hover:bg-emerald-400 transition-all"
                                >
                                    Join Global Reserve
                                </motion.button>
                            </Link>
                            ...
                            <Link to="/map">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="px-8 py-5 bg-white/5 backdrop-blur-xl text-white rounded-2xl font-bold text-lg border border-white/10 hover:border-white/20 transition-all flex items-center gap-3"
                                >
